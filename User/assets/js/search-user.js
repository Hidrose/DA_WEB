...
const products = [
    { name: 'Cây để bàn', link: './Caydeban-user.html' },
    { name: 'Cây ngoài trời', link: './cayngoaitroi-user.html' },
    { name: 'Cây văn phòng', link: './Cayvanphong-user.html' },
    { name: 'Cây sen đá', link: './Caysenda-user.html' },
